...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    <div class="page-header pull-left">
        <div class="page-title">EXERCISE ENABLE</div>
    </div>
    <ol class="breadcrumb page-breadcrumb pull-left">
        <li><i class="fa fa-home"></i>&nbsp;<a href="/admin/">Home</a>&nbsp;&nbsp;<i
                class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
        <li>Classroom Exercise Enable</li>
    </ol>
...
<script src="/assets/admin/js/exercise-enable.js"></script>
<script>
var OME = OME || {};
...
<div class="row" style="margin:20px -15px;" data-ng-init="init()">
    <div class="col-lg-12">
        ...
        <input type="submit" value="Save" style="margin-top:20px" ng-click="saveExerciseWeeks();">
