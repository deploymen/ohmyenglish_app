...
<script src="/assets/admin/js/classroom-exercise-week-template5.js"></script>
@stop
          ...
          <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
              <tr ng-repeat="question in questions track by $index">
                <td class="answerT5">
                  <div>
                    <input type="text" value="@{{question}}" name="answerT5" class="form-control" ng-model="questions[$index]">
                  </div>
                </td>
              </tr>
            </tbody>
