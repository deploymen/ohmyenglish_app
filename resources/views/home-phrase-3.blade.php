                    ...
                    <div class="container ">
                        <div class="row">
                            ...
                            <div class="aniHenry"></div>
                                <img src="{{asset('assets/images/home/meet_taylor.png')}}" alt="Taylor Marie Smith"/>
                                ...
                                <div class="takeQuizSlider">
                                    <ul>
                                        <li><div class="slideWrap malaysianEnglish">
                                                ...
                                                <div class="btnWrap"><a href="javascript:;" class="cta btnZm btn_lg"><span><b>{{trans('home.takeQuiz_btn')}}<i class="fa fa-chevron-right"></i></b></span></a></div>
                                            </div>
                                        </li>
                        ...
                        <div class="coolEnglishSlider">
                            <ul>
                                <li>
                                    <div class="slideWrap">
                                        <div class="equalH">
                                            <h2 class="titleNormal">{{trans('home.coolEnglish_title1')}}</h2>
                                            <p class="info">{{trans('home.coolEnglish_info1')}}</p>
                                        </div>
                                ...
                                <li>
                                    <div class="slideWrap">
                                        <div class="equalH">
                                            <h2 class="titleNormal">{{trans('home.coolEnglish_title2')}}</h2>
                                            <p class="info">{{trans('home.coolEnglish_info2')}}</p>
                                        </div>
                                        <div class="btnWrap"><a href="#" class="cta btnZm btn_sm" onClick="console.log(['TRACK', 'BM - Artikel', 'BM - Baca lagi'].join(' | '));"><span><b>{{trans('home.coolEnglish_btn')}}<i class="fa fa-chevron-right"></i></b></span></a></div>
                                    </div>
                                </li>
...
>>>>>>> 8468fea35600d6116102aa48a7c8011f146f1985
