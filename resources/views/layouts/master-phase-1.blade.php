	...
	<body class="{{$page or ''}} {{$subPage or ''}}" >
		...
		<div class="master {{$withSkinner or ''}}">
	        ...
	        <nav id="nav" class="ome">
	            <div class="container">
	                <ul class="menu">
	                    <li><a class="home" href="{{LaravelLocalization::getLocalizedURL($lang, trans('routes.home'))}}">{{trans('global.home_menu')}}</a></li>
	                    ...
	                    <li><a class="learn" href="{{LaravelLocalization::getLocalizedURL($lang, trans('routes.learn_exercise'))}}" >{{trans('global.learn_menu')}}</a></li>
	                    <li><a class="play" href="{{LaravelLocalization::getLocalizedURL($lang, trans('routes.play_feed_henry'))}}" >{{trans('global.play_menu')}}</a></li>
