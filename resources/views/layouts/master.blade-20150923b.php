...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="{{App::getLocale()}}" ng-app="omeApp"> <!--<![endif]-->
	...
	-->
		<script type='text/javascript'>
		  googletag.cmd.push(function() {
		    googletag.defineOutOfPageSlot('/4271715/OME_STO_750x550', [750, 550], 'div-gpt-ad-1442995087464-0').addService(googletag.pubads());
		   googletag.pubads().enableSyncRendering();
		    googletag.enableServices();
		  });
		</script>
	...
	<body class="{{$page or ''}} {{$subPage or ''}}" >
			...
			<div class="content">
                ...
                @if ($displayLeftSkinner or 0)
					<div class="leftSkinner">
						...
						<div id='div-gpt-ad-1428392658884-0' style='height:650px; width:200px;'>
							<a href="https://www.xpax.com.my/magicsim" target="_blank"><img src="/assets/images/OME-2015-Gempak-Magic-SIM-Reskin-Left-200x650.jpg" /></a>
							<script type='text/javascript'>
							googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428392658884-0'); });
							</script>
						</div>
                ...
                @if ($displayRightSkinner or 0)
					<div class="rightSkinner">
						...
						<div id='div-gpt-ad-1428392658884-0' style='height:650px; width:200px;'>
							<a href="https://www.xpax.com.my/magicsim" target="_blank"><img src="/assets/images/OME-2015-Gempak-Magic-SIM-Reskin-Right-200x650.jpg" /></a>
							<script type='text/javascript'>
							googletag.cmd.push(function() { googletag.display('div-gpt-ad-1428392658884-0'); });
							</script>
						</div>
		...
		<!-- /4271715/OME_STO_750x550 -->
		<div id='div-gpt-ad-1442995087464-0'>
			<script type='text/javascript'>
			googletag.cmd.push(function() { googletag.display('div-gpt-ad-1442995087464-0'); });
			</script>
		</div>
