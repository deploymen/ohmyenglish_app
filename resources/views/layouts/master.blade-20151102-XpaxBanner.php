		...
		<div class="master {{$withSkinner or ''}}">
			...
			<div class="content">
                ...
                @if ($displayLbBanner or 0)
                	...
                	<!-- 
					<div class="lbBanner">
						<div id='div-gpt-ad-1428392658884-0' style='height:90px; width:100%;'>
							<script type='text/javascript'>
					...
					<!-- 1280x176 -->
					<div class="lbBanner-2">
						<div style='height:176px; width:100%;'><!-- 1280px -->
							<a href="https://www.xpax.com.my/magicsim" target="_blank">
								<img src="/assets/images/3041_OME-2015-Site-Takeover-and-Reskinning_Carousel_1280x176.jpg">
							</a>
						</div>
					</div>

					<!-- 728 -->
					<div class="tvBanner-2">
						<div style='width:728px; margin: auto;'><!-- 728px -->
							<a href="https://www.xpax.com.my/magicsim" target="_blank">
								<img width="728px" src="/assets/images/3041_OME-2015-Site-Takeover-and-Reskinning_Carousel_1280x176.jpg">
							</a>
						</div>
					</div>

					<!-- 468 -->
					<div class="mhBanner-2">
						<div style='width:468px; margin: auto;'><!-- 468px -->
							<a href="https://www.xpax.com.my/magicsim" target="_blank">
								<img width="468px" src="/assets/images/3041_OME-2015-Site-Takeover-and-Reskinning_Carousel_1280x176.jpg">
							</a>
						</div>
					</div>

					<!-- 320 -->
					<div class="mvBanner-2">
						<div style='width:320px; margin: auto;'><!-- 320px -->
							<a href="https://www.xpax.com.my/magicsim" target="_blank">
								<img width="320px" src="/assets/images/3041_OME-2015-Site-Takeover-and-Reskinning_Carousel_1280x176.jpg">
							</a>
						</div>
					</div>
